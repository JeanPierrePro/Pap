      ...
      <main className="flex-1 p-6 flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 overflow-hidden pb-4">
          <section className="lg:col-span-7 bg-emerald-50 rounded-[45px] p-12 flex flex-col items-center justify-center border border-emerald-100 text-center">
             ...
             <h2 className="text-3xl font-black text-emerald-900 italic uppercase">Qual sua dúvida?</h2>
             <p className="text-emerald-700/60 font-bold text-sm uppercase tracking-widest mt-2">Gramática, Sintaxe ou Literatura</p>
          </section>

          <section className="lg:col-span-5 bg-slate-900 rounded-[45px] flex flex-col overflow-hidden border border-slate-800">
             <div className="flex-1 p-6 space-y-4">
                <div className="bg-white/5 p-4 rounded-2xl text-emerald-200 text-sm">"Olá! Pode perguntar qualquer coisa. Vou te explicar até você dominar o assunto."</div>
             </div>
             <div className="p-6 bg-white/5 flex gap-2 border-t border-white/5">
                <input className="flex-1 bg-transparent border border-white/10 p-4 rounded-2xl text-white outline-none focus:border-emerald-500/50" placeholder="Digite sua dúvida..." />
